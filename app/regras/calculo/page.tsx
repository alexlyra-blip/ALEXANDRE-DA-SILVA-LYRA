...
export default function RegrasCalculo() {
    ...
    try {
      const bankData = {
        ...
        tabelas: tabelas.filter(t => t.nome && t.coeficiente).map(t => ({
          ...
          taxaTabela: 0,
          taxaDiferencial: 0,
          ajusteTaxaPonderada: 0,
          useMinTicket: true,
          useTaxaPonderada: true
        }))
      };
  ...
  return (
    <div className="flex flex-col min-h-screen w-full md:max-w-none mx-auto max-w-2xl bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display pb-24 md:pb-0">
      {/* TopAppBar */}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className={`w-full bg-slate-50 dark:bg-slate-800 border rounded-lg px-3 py-2 text-sm focus:ring-2 outline-none transition-all ${
                  ...
                  />
                  {fieldErrors.bankName && <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest">{fieldErrors.bankName}</span>}
                </div>
                <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      placeholder="Ex: 18" 
                    />
                    {fieldErrors.minAge && <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest">{fieldErrors.minAge}</span>}
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      placeholder="Ex: 75" 
                    />
                    {fieldErrors.maxAge && <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest">{fieldErrors.maxAge}</span>}
                  </div>
                </div>
              </div>
