...
import { ArrowLeft, User, Lock, Eye, LogIn, ShieldCheck, Palette, Loader2 } from 'lucide-react';
...
export default function PromotoraLogin() {
  ...
  useEffect(() => {
    ...
    // Safety timeout to ensure we don't stay stuck on the loader
        ...
        if (error.code === 'resource-exhausted' || error.message?.includes('Quota exceeded')) {
          ...
          if (cached) {
            try {
              ...
              console.error("Error using expired cache", err);
            }
          }
        }
        setIsFindingPromotora(false);
  ...
  return (
    <div className="flex flex-col h-full min-h-screen w-full max-w-md mx-auto bg-white dark:bg-slate-950 overflow-x-hidden shadow-2xl">
      {/* Top App Bar */}
      ...
      <div className="w-full">
        {branding.loginImageUrl ? (
          ...
          <div className="w-full h-32 bg-slate-100 dark:bg-slate-900 flex items-center justify-center text-primary/40">
